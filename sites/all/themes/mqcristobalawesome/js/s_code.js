...
var s_account="mediacorp-mcs-prd"
...
s.linkInternalFilters="javascript:,todayonline.com"
...
function s_doPlugins(s) {
	...
	/* Time Parting */
	s.prop17=s.getTimeParting('h','8'); // Set hour 
	s.prop18=s.getTimeParting('d','8'); // Set day 
	s.prop19=s.getTimeParting('w','8'); // Set weekday 
	s.eVar17=s.prop17;
	s.eVar18=s.prop18;
	s.eVar19=s.prop19;
...
s.Media.playerName="___";
s.Media.trackWhilePlaying=true;
s.Media.trackUsingContextData =true;
s.Media.trackVars="events,eVar13,eVar21,eVar22,,eVar24,prop10";
s.Media.trackEvents="event22,event23,event24,event10,event14,event16,event17";
